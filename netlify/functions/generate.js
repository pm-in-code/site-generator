    ...
    const openaiResponse = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `Create a beautiful, modern HTML page with inline CSS. Include responsive design, modern colors, and images from https://picsum.photos/. Add "Generated by BRAYN - Prompt2Site" in footer. Return ONLY HTML code.`
          },
          {
            role: 'user',
            content: prompt
